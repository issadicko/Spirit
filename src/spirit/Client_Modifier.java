 ...
 * @author genius
 */
public class Client_Modifier extends JDialog {
     ...
     * @param modale
     */
    public Client_Modifier(JFrame parent, String title,boolean modale) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modification des données d'un client");
    ...
    public Client showMe(Client cl){
        
        
        
        if(cl != null){
            
            id.setText(cl.getId());id.setEnabled(false);
            adresse.setText(cl.getAdresse());
            nom.setText(cl.getNom());
            prenom.setText(cl.getPrenom());
            contact.setText(cl.getContact());
